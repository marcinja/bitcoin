...
static UniValue searchrawtransactions(const JSONRPCRequest& request) {
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "\nArguments:\n",
                {
                    {"address", RPCArg::Type::STR_HEX, /* opt */ false, /* default_val */ "", "address or scriptPubKey"},
                    {"verbose", RPCArg::Type::BOOL, /* opt */ true, /* default_val */ "false", "If false, return hex-encoded tx, otherwise return a json object"},
                    {"count", RPCArg::Type::NUM, /* opt */ true, /* default_val */ "", "The block in which to look for the transaction"},
                }}
                .ToString() +
            "\nResult:\n"
